...
async function searchWeather(cityName) {
  fetch(`https://api.openweathermap.org/data/2.5/weather?q=${cityName}&units=imperial&appid=${apiKey}`)
    ...
    //  document.querySelector(".day").innerHTML = data.dt_txt.toLocaleString();
      ...
      //--------------------------------- var currDate =  new Date(fiveDayArray[i].dt_txt).toLocaleString() ------------------------------------------------------------------------------     
        ...
        .then(function (response) {
          ...
          for (i = 0; i < 40; i = i + 8) {
            if (i === 0) {
              ...
              document.querySelector(".date1").innerHTML = data5.list[i].dt_txt;         
              ...
              document.querySelector(".date2").innerHTML = data5.list[i].dt_txt; 
              ...
              document.querySelector(".date3").innerHTML = data5.list[i].dt_txt; 
              ...
              document.querySelector(".date4").innerHTML = data5.list[i].dt_txt; 
              ...
              document.querySelector(".date5").innerHTML = data5.list[i].dt_txt; 
